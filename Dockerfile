...
RUN cd /var/www/html && \
    ...
    bin/magento setup:install \
        --db-host="cmg-dev.c4z8df29y2ox.ap-southeast-1.rds.amazonaws.com" \
        --db-name="thepd-test" \
        --db-user="admin" \
        --db-password="TMKeSGbWbPUYb7G" \
        --base-url=https://cmg.bigbot.cc/ \
        --base-url-secure=https://cmg.bigbot.cc/ \
    ...
    bin/magento config:set web/secure/base_url https://cmg.bigbot.cc/ && \
    bin/magento config:set web/unsecure/base_url https://cmg.bigbot.cc/ && \
